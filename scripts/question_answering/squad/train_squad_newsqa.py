...
parser.add_argument("--squad_q_p_file", default=None, help="Squad Question Paragraph pickle file")
parser.add_argument("--newsqa_q_p_file", default=None, help="NewsQA Question Paragraph pickle file")
...
squad_q_p = pickle.load(open(args.squad_q_p_file, 'rb'))
newsqa_q_p = pickle.load(open(args.newsqa_q_p_file, 'rb'))

q_p = squad_q_p + newsqa_q_p
random.shuffle(q_p)
